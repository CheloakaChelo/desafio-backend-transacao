...
public class TransacaoService {
    ...
    public Transacao criarTransacao(TransacaoDTO transacao) throws Exception {
        Usuario remetente = (Usuario) usuarioService.findById(transacao.remetente_id());
        Usuario destinatario = (Usuario) usuarioService.findById(transacao.destinatario_id());
    ...
    public boolean autorizarTransacao(Usuario remetente, BigDecimal quantidade){
        ...
        if (autorizacaoResponse.getStatusCode() == HttpStatus.OK && autorizacaoResponse.getBody() != null){
